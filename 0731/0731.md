...
- `predict()` 함수
    ...
    - 예2) 한국 occurrence 데이터로 fitting 시킨 bioclim 모델로 이팝나무(Chionanthus retusus)가 일본의 어느 곳에 살만한지 예측해보기
        ```R
        ################################################################
        # 한국 데이터 준비
        ################################################################
        ...
        [1] 0.3406721
        ```
    - 예3) rcp 시나리오 상, 한국 데이터로 fitting 시킨 bioclim 모델로 이팝나무가 일본 중심 위치에서 존재할 확률 구하기
        ```R
        ################################################################
        # 한국 데이터 준비
        ################################################################
